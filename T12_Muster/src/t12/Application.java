...
import t12.spinphone.implement.*;
...
//		useGUIPhone();
	...
	private static void useGUIPhone() {
		...
		T12Interpreter interpreter = new T12InterpreterImplement();
	...
	public static void useConsolePhone() {
		...
		phone.createLexicon("data","SpinPhone.lex");
		 ...
		 phone.typeAsNumbers("h");
		 phone.typeAsNumbers("he");
		 phone.typeAsNumbers("hei");
		 phone.typeAsNumbers("heiß");

		 phone.displayAlternative();
		 phone.learn("Informationsverarbeitung");
		 phone.typeAsNumbers("Informationsverarbeitung");
		 phone.learn("Johanna");
		 phone.typeAsNumbers("Johanna");
		 
		 interpreter.saveT9Tree();
//		 interpreter.loadT9Tree();
	}
